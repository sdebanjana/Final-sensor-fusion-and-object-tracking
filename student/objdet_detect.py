...
def load_configs_model(model_name='darknet', configs=None):
    ...
    if model_name == "darknet":
        ...
        # #extra_configs = {'conf_thresh':0.5, 'saved_fn': 'fpn_resnet', 'arch': 'fpn_resnet', 'pretrained_path': '../checkpoints/fpn_resnet/fpn_resnet_epoch_300.pth', 
        #                  'K': 50, 'no_cuda': False, 'gpu_idx': 0, 'num_samples': None, 'num_workers': 1, 'batch_size': 1, 'peak_thresh': 0.2, 
        #                  'save_test_output': False, 'output_format': 'image', 'output_video_fn': 'out_fpn_resnet', 'output_width': 608, 
