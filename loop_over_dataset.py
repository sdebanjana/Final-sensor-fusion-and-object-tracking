...
data_filename = 'training_segment-1005081002024129653_5313_150_5333_150_with_camera_labels.tfrecord' #final _3,4 # Sequence 1, ID_S1_E1, ID_S2_EX1, ID_S2_EX2,3

#data_filename = 'training_segment-10072231702153043603_5725_000_5745_000_with_camera_labels.tfrecord' # Sequence 2, for final term 
#data_filename = 'training_segment-10963653239323173269_1924_000_1944_000_with_camera_labels.tfrecord' # Sequence 3 ID_S1_E2
#show_only_frames = [0, 1] #ID_S1_E1, #ID_S2_EX1, ID_S2_EX2,3 
#show_only_frames = [150, 200] #Final_step1
#show_only_frames = [65, 100] #Final_step2
show_only_frames = [0, 200] #final_S3.4
#show_only_frames = [50, 51] #ID_S3_E1
# show only frames in interval for debugging
#show_only_frames = [0, 200] #ID_S1_E2
#show_only_frames = [0, 200] #ID_S4_E2
...
#configs_det.lim_y = [-5, 15] #final_S2
configs_det.lim_y = [-25, 25] #final_S3,4
#configs_det.lim_y = [-5, 10] #FINAL_STEP1
...
#exec_tracking = [] # options are 'perform_tracking' ID_S1_EX1,2, ID_S2_EX1,2,3, S3_EX1, S4
exec_tracking = ['perform_tracking'] #final_s1,
#exec_detection = ['bev_from_pcl'] #ID_S2_EX1, ID_S2_EX2,3
#exec_detection = ['bev_from_pcl', 'detect_objects'] #ID_S3_EX1

exec_detection = [] #final_s1
...
#exec_visualization = [] #ID_S2_EX1, ID_S2_EX2,3
exec_visualization = ['show_tracks'] #Final_step1,2,3
#exec_visualization = ['show_tracks', 'make_tracking_movie'] #final_S4
#exec_visualization = ['show_objects_in_bev_labels_in_camera'] #ID_S3_EX1
#configs_det = det.load_configs(model_name="darknet")
#exec_visualization = ['show_range_image'] #ID_S1_E1
#exec_visualization = ['show_pcl'] #ID_S1_E2
